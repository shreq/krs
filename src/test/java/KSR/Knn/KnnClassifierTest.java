...
public class KnnClassifierTest {
    ...
    public void shouldClassifyProperly() {
        ArrayList<Double> a = new ArrayList<>(List.of(1.0, 1.0));
        ArrayList<Double> b = new ArrayList<>(List.of(1.0, -1.0));
        ArrayList<Double> c = new ArrayList<>(List.of(-1.0, -1.0));
        ArrayList<Double> x = new ArrayList<>(List.of(2.0, 2.0));
